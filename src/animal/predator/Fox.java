...
public class Fox extends Animal implements Runnable,Behaviorable{
    private List<Animal> newPredator;

    public Fox(Field field, Location location, List<Animal> newPredator) {
    ...
    @Override
    public void run() {
        System.out.println("Thread Fox run!");
        act(newPredator);
        incrementAge();
        incrementHunger();
        findFood();
